...
# dataset_root_path = "./data/recodings_affected_by_noise/live_recordings"
dataset_root_path = os.path.join(os.path.dirname(__file__), os.pardir, "data/recodings_affected_by_noise/live_recordings")
